...
// import 'aitaku_candidate.dart'; // Import the reservation_confirmed.dart file

// class ReservationConfirmed extends StatefulWidget {
//   final int orderId; // orderId を追加

//   ReservationConfirmed({required this.orderId}); // コンストラクタに orderId を追加

//   @override
//   _ReservationConfirmedState createState() => _ReservationConfirmedState();
// }

// class _ReservationConfirmedState extends State<ReservationConfirmed> {
...
//                 MaterialPageRoute(
//                   builder: (context) =>
//                       ReservationConfirmed(orderId: widget.orderId), // 修正済み
//                 ),
//               );
//             },
