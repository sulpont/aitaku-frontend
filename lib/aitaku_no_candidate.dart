...
class AitakuNoCandidate extends StatelessWidget {
  final int orderId; // orderId を追加

  AitakuNoCandidate({required this.orderId}); // コンストラクタに orderId を追加

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('候補が見つかりません'),
        centerTitle: true,
        leading: IconButton(
      ...
      body: Column(
        ...
        children: [
          ...
          const Icon(
            ...
            size: 80,
            color: Colors.red,
          ), // Red error icon indicating no candidates found
